<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="{{ url('dashboard') }}"
                class="nav-item {{ request()->route()->uri == 'dashboard' ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                </svg>
                Dashboard
            </a>
            <a href="{{ url('counselor-panel') }}"
                class="nav-item {{ request()->route()->uri == 'counselor-panel' ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                </svg>
                Counselor Panel
    ...
    <div class="sidebar-footer">
        ...
        <form method="POST" action="{{ route('logout') }}" class="logout-form" id="logoutForm">
            @csrf
            <button type="button" class="nav-item logout-btn" id="logoutBtn">
